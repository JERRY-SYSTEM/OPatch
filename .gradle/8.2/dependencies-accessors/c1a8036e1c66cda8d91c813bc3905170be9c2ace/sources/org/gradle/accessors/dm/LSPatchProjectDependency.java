...
@NonNullApi
public class LSPatchProjectDependency extends DelegatingProjectDependency {

    @Inject
    public LSPatchProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
